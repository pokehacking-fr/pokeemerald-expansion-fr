...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_LEVEL_UP_MOVES]  = {COMPOUND_STRING("CAP. NIVEAU"),        CursorCb_ChangeLevelUpMoves},
    [MENU_EGG_MOVES]       = {COMPOUND_STRING("CAP. OEUF"),          CursorCb_ChangeEggMoves},
    [MENU_TM_MOVES]        = {COMPOUND_STRING("CAP. CT"),            CursorCb_ChangeTMMoves},
    [MENU_TUTOR_MOVES]     = {COMPOUND_STRING("CAP. APPRISE"),       CursorCb_ChangeTutorMoves},
    [MENU_SUB_MOVES]       = {COMPOUND_STRING("APPRENDRE CAP."),     CursorCb_LearnMovesSubMenu},
