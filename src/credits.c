...
static void LoadTheEndScreen(u16 tileOffsetLoad, u16 tileOffsetWrite, u16 palOffset)
{
    ...
    DecompressDataWithHeaderVram(gCreditsCopyrightEnd_Gfx, (void *)(VRAM + tileOffsetLoad));
...
{
    DecompressDataWithHeaderVram(gCreditsCopyrightEnd_Tilemap, (void *)(VRAM + offset));
}
